        ...
        <table cellpadding="15" style="margin-left: 10px; margin-top: 5px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" CssClass="ErrorInput" ControlToValidate="txtResidencia" ErrorMessage="Por favor ingrese su dirreción." Text="*" runat="server"></asp:RequiredFieldValidator>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="formText" style="margin-top: 15px; padding-top: 15px;">

                    <table>
                        <tr style="width: 100%; font-weight: bold">
                            <td colspan="3">
                                <asp:Label ID="lblVueloSalidaTitulo" runat="server" Text="Vuelo"></asp:Label>
                            </td>
                        </tr>

                        <tr style="width: 100%;">
                            <td colspan="2">Nro. de Vuelo:</td>
                            <td>
                                <asp:Label ID="lblVueloSalida" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>

                        <tr style="width: 100%;">
                            <td colspan="2">Clase de Cabina:</td>
                            <td>
                                <asp:Label ID="lblClaseVueloSalida" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>

                        <tr style="width: 100%;">
                            <td colspan="2">Asiento:</td>
                            <td>
                                <asp:Label ID="lblAsientoVueloSalida" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>

                        <tr style="width: 100%;">
                            <td colspan="2">Pasajeros:</td>
                            <td>
                                <asp:Label ID="lblPasajerosVueloSalida" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr style="width: 100%;">
                            ...
                            <td>
                                <asp:Label ID="lblTarifaVueloSalida" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr style="width: 100%;">
                            ...
                            <td>
                                <asp:Label ID="lblSubtotalVueloSalida" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
                ...
                <td class="formText" style="margin-top: 15px; padding-left: 20px; padding-top: 15px;">

                    <table id="detalleVueloRegreso" visible="false" runat="server">
                        <tr style="width: 100%; font-weight: bold">
                            <td colspan="3">
                                <asp:Label ID="lblVueloRegresoTitulo" runat="server" Text="Vuelo"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr style="width: 100%;">
                            <td colspan="2">Nro. de Vuelo:</td>
                            <td>
                                <asp:Label ID="lblVueloRegreso" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr style="width: 100%;">
                            <td colspan="2">Clase de Cabina:</td>
                            <td>
                                <asp:Label ID="lblClaseVueloRegreso" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr style="width: 100%;">
                            <td colspan="2">Asiento:</td>
                            <td>
                                <asp:Label ID="lblAsientoVueloRegreso" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr style="width: 100%;">
                            <td colspan="2">Pasajeros:</td>
                            <td>
                                <asp:Label ID="lblPasajeroVueloRegreso" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr style="width: 100%;">
                            <td colspan="2">Tarifa:</td>
                            <td>
                                <asp:Label ID="lblTarifaVueloRegreso" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr style="width: 100%;">
                            <td colspan="2">SubTotal:</td>
                            <td>
                                <asp:Label ID="lblSubtotalVueloRegreso" runat="server" Text="0"></asp:Label>
                            </td>
                        </tr>
            ...
            <tr style="width: 100%; font-size: 11px; font-weight: bold; color: #ff6a00">
                <td colspan="2">TOTAL US$:   <asp:Label ID="lblTotal" runat="server" Text="0"></asp:Label></td>
            </tr>
            ...
            <tr>
                <td colspan="2" class="formText" style="margin-top: 15px; padding-top: 15px;">
                    <asp:CheckBox ID="chbAcceptConditions" Text="&nbsp;Aceptó terminos y condiciones" runat="server" /></td>
            </tr>
